...
const unsigned pwm_freq       =  25833; // use the 3rd harmonic to generate 77.5 kHz
const unsigned pwm_pin        =      4;
const unsigned pwm_resolution =      4;
const unsigned pwm_duty_off   =      0;
const unsigned pwm_duty_on    =      7;
